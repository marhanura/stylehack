...
export default function Footer() {
  return (
    <footer className="footer sm:footer-horizontal bg-[#E7DFD1] text-black p-10">
      <aside>
        ...
        <p>
          © 2025 StyleHack. All rights reserved.
          {/* <br />
          Fashion made easy, personalized, and effortless. */}
        </p>
      </aside>
      <nav className="text-right ml-auto">
        <h6 className="footer-title text-right w-full">Connect with us</h6>
